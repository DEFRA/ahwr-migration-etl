...
var raw = fs.readFileSync('/home/cdpshell/TestNewWorldApplications.json');
var docs = EJSON.parse(raw);

db.applications.insertMany(docs);

raw = fs.readFileSync('/home/cdpshell/TestOldWorldApplications.json');
docs = EJSON.parse(raw);

db.owapplications.insertMany(docs);

raw = fs.readFileSync('/home/cdpshell/TestClaims.json');
docs = EJSON.parse(raw);

db.claims.insertMany(docs);

raw = fs.readFileSync('/home/cdpshell/TestHerds.json');
docs = EJSON.parse(raw);
